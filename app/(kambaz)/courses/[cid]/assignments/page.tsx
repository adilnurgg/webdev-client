...
export default async function Assignments({
  ...
  return (
    <div id="wd-assignments">
        ...
        <br />
        <h3 id="wd-assignments-title" >ASSIGNMENTS 40% of Total <button id="wd-plus">+</button></h3>
      <ul id="wd-assignment-list">
        <AssignmentItem cid={cid} aid="123" title="A1 - ENV + HTML" details="Multiple Modules | Not available until May 6 at 12:00am |
Due May 13 at 11:59pm | 100 pts"/>
        <AssignmentItem cid={cid} aid="456" title="A2 - CSS + TAILWIND" details="Multiple Modules | Not available until May 13 at 12:00am |
